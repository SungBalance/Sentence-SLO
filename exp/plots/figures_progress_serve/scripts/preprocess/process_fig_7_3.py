...
from fig7_unit_miss_0_5_common import (  # noqa: E402
    DEFAULT_RAW_DATA,
    DEFAULT_SOURCE_DATA,
    PROCESSED_DIR,
    preprocess_fig7_3,
...
def main() -> None:
    ...
    parser.add_argument("--selected", type=Path, default=DEFAULT_SOURCE_DATA)
    ...
    preprocess_fig7_3(args.selected, args.data, args.out_dir)
