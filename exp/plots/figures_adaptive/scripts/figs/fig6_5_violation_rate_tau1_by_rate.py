...
_BASENAME = "fig6_5_violation_rate_tau1_by_rate"
...
def plot_fig6_5(input_path: Path, output_path: Path) -> None:
    plot_line_grid(
        input_path,
        output_path,
        value_column="violation_rate_pct",
        ylabel="Violation Rate @ tau=1 (%)",
    )
...
def main() -> None:
    ...
    plot_fig6_5(args.data, args.out)
