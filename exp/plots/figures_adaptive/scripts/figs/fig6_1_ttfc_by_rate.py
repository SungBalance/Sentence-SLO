...
def preprocess_fig6_1(
    ...
    preprocess_summary_metric(
        ...
        output_dir,
        basename=_BASENAME,
        metric_column="ttfc_p95_s",
        value_column="ttfc_p95_s",
    )


def plot_fig6_1(input_path: Path, output_path: Path) -> None:
    plot_line_grid(
        input_path,
        output_path,
        value_column="ttfc_p95_s",
...
def main() -> None:
    ...
    plot_fig6_1(args.data, args.out)
