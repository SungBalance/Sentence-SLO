...
_BASENAME = "fig6_4_request_stall_count_tau0_by_rate"
...
def plot_fig6_4(input_path: Path, output_path: Path) -> None:
    plot_stall_count_grid(
        input_path,
        output_path,
        ylabel="Stall Count per Request @ tau=0",
    )
...
def main() -> None:
    ...
    plot_fig6_4(args.data, args.out)
