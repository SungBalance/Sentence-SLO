...
def plot_fig7_4(input_path: Path, output_path: Path) -> None:
    plot_hierarchical_grouped_bar(
        input_path,
        output_path,
        value_column="unit_deadline_miss_rate",
        ylabel="Violated chunk ratio (%)",
        value_scale=100.0,
        mark_missing=True,
...
def main() -> None:
    ...
    plot_fig7_4(args.data, args.out)
