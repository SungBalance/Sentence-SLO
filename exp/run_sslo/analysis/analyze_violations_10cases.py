...
directories (e.g. exp/run_sslo/output_sweep_optA) and prints a per-case
...
Usage:
  ...
  python3 analyze_violations_10cases.py \\
    exp/run_sslo/output_sweep_optA \\
    exp/run_sslo/output_sweep_optB
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "sweep_dirs", nargs="+",
        help="Sweep base dirs (e.g. exp/run_sslo/output_sweep_optA).")
    parser.add_argument(
